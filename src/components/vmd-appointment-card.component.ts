                    ...
                    <div class="row align-items-center ">
                        <div class="col">
                            ...
                            <div class="row">
                              ...
                              <vmd-appointment-metadata widthType="fit-to-content" icon="vmdicon-telephone-fill" .displayed="${!!this.lieu.metadata.phone_number}">
                                <span slot="content">${this.lieu.metadata.phone_number}</span>
                              </vmd-appointment-metadata>
                              <vmd-appointment-metadata widthType="fit-to-content" icon="vmdicon-commerical-building">
